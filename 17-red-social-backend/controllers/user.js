...
const register = (req, res) => {
    ...
    User.find({
        ...
        let pwd = await bcrypt.hash(params.password, 10);   //te forma la contraseña ilegible (bcrypt es un metodo de hasheo conocido)
        params.password = pwd;   // pisa la nueva password q pusieron por input con la ilegible.
...
const login = (req, res) => {
    ...
    User.findOne({ email: params.email })
        ...
        .exec((error, user) => {
            ...
            const pwd = bcrypt.compareSync(params.password, user.password);  // te devuelve True o False segun si existe o no la psword
...
const update = (req, res) => {
    console.log("Console log update", update)
